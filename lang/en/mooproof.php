...
$string['nosubmissionsyet'] = 'No submissions have been made yet.';
...
$string['submissionscount'] = 'submissions';
$string['chatmessagescount'] = 'chat messages';
$string['submittedpaper'] = 'Submitted Paper';
$string['aifeedback'] = 'AI Feedback';
$string['chatconversation'] = 'Follow-up Chat';
$string['nochatmessages'] = 'No follow-up chat messages for this submission.';
$string['aitutor'] = 'AI Tutor';
$string['words'] = 'words';
$string['gradelevelshort'] = 'Grade';
$string['mooproof:viewhistory'] = 'View student submission history';
$string['resetsubmissions'] = 'Delete all MooProof submissions and chat history';
...
$string['completionsubmit'] = 'Student must submit a paper for proofing';
